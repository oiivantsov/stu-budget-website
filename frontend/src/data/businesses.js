...
export const businesses = [
    {
        ...
        coordinates: { lat: 60.16763171124735, long: 24.93563135889214 },
        images: [food1, food2, food3, food4, cafe1, cafe2],
        reviews: {
            total: 3,
            average: 4.66,
            ratings: [
    ...
    },
    {
        ...
        coordinates: { lat: 60.16548541370081, long: 24.943744324169458 },
    ...
    },
    {
        ...
        coordinates: { lat: 60.168666833036994, long: 24.947161531671995 },
        images: [],
        reviews: {
            total: 2,
            average: 5.0,
    ...
    },
    {
        ...
        coordinates: { lat: 60.17043058097076, long: 24.93684390327354 },
        images: [food1, food2, food3],
        reviews: {
            total: 2,
            average: 4.5,
    ...
    },
    {
        ...
        coordinates: { lat: 60.16864627145819, long: 24.95424007584397 },
        images: [food1, food2, food3],
        reviews: {
            total: 2,
            average: 4.5,
    ...
    },
    {
        ...
        coordinates: { lat: 60.16909575362763, long: 24.944918835960237 },
        images: [food1, food2, food3],
        reviews: {
            total: 2,
            average: 4.5,
    ...
    },
    {
        ...
        coordinates: { lat: 60.16706762460777, long: 24.939853727266065 },
        images: [food1, food2, food3],
        reviews: {
            total: 2,
            average: 4.0,
    ...
    },
    {
        ...
        coordinates: { lat: 60.164818716312034, long: 24.942955014655478 },
        images: [food1, food2, food3],
        reviews: {
            total: 2,
            average: 4.5,
    ...
    },
    {
        ...
        coordinates: { lat: 60.168445293403146, long: 24.943189537986186 },
        images: [food1, food2, food3],
        reviews: {
            total: 2,
            average: 4.5,
    ...
    },
    {
        ...
        coordinates: { lat: 60.16105911342521, long: 24.94132580898967 },
        images: [food1, food2, food3],
        reviews: {
            total: 2,
            average: 4.5,
